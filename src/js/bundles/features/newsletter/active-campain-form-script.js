/* eslint-disable */
/* TODO DELETE */
export const runActiveCampaign = () => {
  window.cfields = [];
  ...
  (function () {
    ...
    var form_submit = function (e) {
      ...
      if (validate_form()) {
        ...
        var serialized = _form_serialize(document.getElementById("_form_1_")).replace(
          /%0A/g,
          "\\n"
        );
        ...
        _load_script(
          "https://bethelmedia.activehosted.com/proc.php?" + serialized + "&jsonp=true",
